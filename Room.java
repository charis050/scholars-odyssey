...
import java.util.ArrayList; // or java.util.*; and replace the
...
public class Room 
{
    ...
    private ArrayList<Item> items; //an ArrayList of items in the room
    ...
    /**
     * Return an ArrayList of the items in the room
     *
     * @return An ArrayList of the items in the room
     */
    ...
    {
        // let's use a StaringBuilder (not required)
